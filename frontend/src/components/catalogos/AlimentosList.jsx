...
export default function AlimentosList() {
  ...
  const handleCreate = async (e) => {
    ...
    const variables = {
      ...
      contenidoNeto: parseFloat(formData.get('contenidoNeto')) || 0,
      unidadMedida: formData.get('unidadMedida'),
      fechaVencimiento: formData.get('fechaVencimiento'),
      stockCantidad: parseFloat(formData.get('stockCantidad')) || 0,
      precioReferencia: parseFloat(formData.get('precioReferencia')) || 0,
    }
    ...
    <div>
      ...
      {alimentos.length === 0 ? (
        <div className="text-center py-20 bg-gray-50 rounded-lg">
          <p className="text-gray-500">No hay alimentos registrados</p>
        </div>
      ) : (
              ...
              <form onSubmit={editingAlimento ? handleUpdate : handleCreate}>
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    name="nombre"
                    defaultValue={editingAlimento?.nombre || ''}
                ...
                <div className="mb-3">
                  ...
                  <select
                    name="unidadMedida"
                    defaultValue={editingAlimento?.unidadMedida || 'KG'}
                    className="w-full px-3 py-2 border rounded-md"
                  >
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    step="0.01"
                    name="stockCantidad"
                    defaultValue={editingAlimento?.stockCantidad || 0}
                    className="w-full px-3 py-2 border rounded-md"
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    defaultValue={editingAlimento?.precioReferencia || 0}
                    className="w-full px-3 py-2 border rounded-md"
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    defaultValue={editingAlimento?.fechaVencimiento || ''}
                    className="w-full px-3 py-2 border rounded-md"
                  />
                </div>
                {editingAlimento && (
                  <div className="mb-4">
                    ...
                    <select
                      name="activo"
                      defaultValue={editingAlimento.activo ? 'true' : 'false'}
                      className="w-full px-3 py-2 border rounded-md"
                    >
